...
namespace BindingsRx.UI
{
    public static class CanvasElementExtensions
    {
        ...
        { return input.transform.BindPositionTo(property, bindingType, filters); }
        ...
        { return input.transform.BindPositionTo(getter, setter, bindingType, filters); }
        ...
        { return input.transform.BindRotationTo(property, bindingType, filters); }
        ...
        { return input.transform.BindRotationTo(getter, setter, bindingType, filters); }
        ...
        { return input.transform.BindScaleTo(property, bindingType, filters); }
        ...
        { return input.transform.BindScaleTo(getter, setter, bindingType, filters); }
    }
}