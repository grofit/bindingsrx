...
namespace BindingsRx.GameObjects
{
    public static class GameObjectExtensions
    {
        ...
        { return GenericBindings.Bind(() => input.activeSelf, input.SetActive, property, bindingType, filters); }
        ...
        { return GenericBindings.Bind(() => input.activeSelf, input.SetActive, getter, setter, bindingType, filters); }
        ...
        { return GenericBindings.Bind(() => input.layer, x => input.layer = x, property, bindingType, filters); }
        ...
        { return GenericBindings.Bind(() => input.layer, x => input.layer = x, getter, setter, bindingType, filters); }
        ...
        { return GenericBindings.Bind(() => input.name, x => input.name = x, property, bindingType, filters); }
        ...
        { return GenericBindings.Bind(() => input.name, x => input.name = x, getter, setter, bindingType, filters); }
        ...
        { return GenericBindings.Bind(() => input.tag, x => input.tag = x, property, bindingType, filters); }
        ...
        { return GenericBindings.Bind(() => input.tag, x => input.tag = x, getter, setter, bindingType, filters); }
    }
}